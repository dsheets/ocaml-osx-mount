...
dispatch begin
  ...
  | After_rules ->
    ...
    (* Linking cstubs *)
    dep ["c"; "compile"; "use_osx_mount_util"]
      ["lib/osx_mount_util.o"; "lib/osx_mount_util.h"];
    flag ["c"; "compile"; "use_ctypes"] & S[A"-I"; A ctypes_libdir];
    flag ["c"; "compile"; "debug"] & A"-g";

    (* Linking generated stubs *)
    dep ["ocaml"; "link"; "byte"; "library"; "use_osx_mount_stubs"]
      ["lib/dllosx_mount_stubs"-.-(!Options.ext_dll)];
    flag ["ocaml"; "link"; "byte"; "library"; "use_osx_mount_stubs"] &
    S[A"-dllib"; A"-losx_mount_stubs"];

    dep ["ocaml"; "link"; "native"; "library"; "use_osx_mount_stubs"]
      ["lib/libosx_mount_stubs"-.-(!Options.ext_lib)];
    flag ["ocaml"; "link"; "native"; "library"; "use_osx_mount_stubs"] &
    S[A"-cclib"; A"-losx_mount_stubs"];

    (* Linking tests *)
    flag ["ocaml"; "link"; "byte"; "program"; "use_osx_mount_stubs"] &
      S[A"-dllib"; A"-losx_mount_stubs"];
    dep ["ocaml"; "link"; "byte"; "program"; "use_osx_mount_stubs"]
      ["lib/dllosx_mount_stubs"-.-(!Options.ext_dll)];

    flag ["ocaml"; "link"; "native"; "program"; "use_osx_mount_stubs"] &
      S[A"-cclib"; A"-losx_mount_stubs"];
    dep ["ocaml"; "link"; "native"; "program"; "use_osx_mount_stubs"]
      ["lib/libosx_mount_stubs"-.-(!Options.ext_lib)];
